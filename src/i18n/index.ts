...
i18
    ...
    .init({
        ...
        defaultNS: 'dashboard',
        ns: ['dashboard', 'tour', 'translation', 'common', 'login', 'register', 'schedules', 'booking', 'payment', 'ratings', 'bookings_report', 'revenue_report', 'location_report', 'users_report', 'reports_common', 'location', 'user', 'contact', 'notification', 'blog', 'settings', 'promotions', 'landing_pages', 'chatbot'], // namespace
