...
i18
    ...
    .init({
        ...
        defaultNS: 'dashboard',
        ns: ['dashboard', 'tour', 'translation', 'common', 'login', 'register', 'schedules', 'booking', 'payment', 'ratings', 'bookings_report', 'revenue_report', 'location_report', 'user', 'contact'], // namespace
