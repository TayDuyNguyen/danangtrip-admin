                        ...
                        >
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-3xl bg-white p-[32px] text-left align-middle shadow-2xl transition-all border border-slate-100">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="p-4 bg-[#f4fce3] border border-[#d9f99d] rounded-2xl">
                                        <p className="text-[12px] font-semibold text-[#365314] font-sans">
                                ...
                                <div className="mt-8 flex items-center gap-3">
                                    ...
                                    <button
                                        type="button"
                                        disabled={isDeleting}
                                        className="flex-1 px-4 h-[48px] bg-[#EF4444] hover:bg-[#DC2626] disabled:opacity-50 text-white text-[14px] font-bold rounded-2xl transition-all"
                                        onClick={onConfirm}
                                    >
