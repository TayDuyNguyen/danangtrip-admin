        ...
        >
            ...
            <div className="lg:w-80 space-y-6 shrink-0">
                <div className="sticky top-28 space-y-6">
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="pt-4 border-t border-slate-100 flex flex-col gap-2">
                                <Button
                                    ...
                                    className={`w-full rounded-2xl h-12 font-bold transition-all shadow-lg ${
                                        publishOption === 'draft'
                                            ? 'bg-amber-500 hover:bg-amber-600 shadow-amber-500/20 text-white'
                                            : 'bg-[#14B8A6] hover:bg-[#0f766e] shadow-[#14B8A6]/20 text-white'
                                    }`}
                                    isLoading={createPostMutation.isPending || isSubmitting}
                                >
                    ...
                    {/* Card 4: Guidelines */}
                    <div className="bg-[#EFF6FF] border border-[#B3D9FF] rounded-3xl p-6 shadow-2xs">
                        <h5 className="text-xs font-black text-[#0066CC] uppercase tracking-wider mb-3 flex items-center gap-1.5">
                            {t('form.sections.guidelines')}
                        </h5>
                        <ul className="space-y-2.5 text-[11px] font-semibold text-slate-700 leading-normal">
                            <li className="flex items-start gap-1.5">
                                <span className="text-[#0066CC] shrink-0 mt-0.5">●</span>
                                <span>{t('form.guidelines.item_1')}</span>
                            </li>
                            <li className="flex items-start gap-1.5">
                                <span className="text-[#0066CC] shrink-0 mt-0.5">●</span>
                                <span>{t('form.guidelines.item_2')}</span>
                            </li>
                            <li className="flex items-start gap-1.5">
                                <span className="text-[#0066CC] shrink-0 mt-0.5">●</span>
                                <span>{t('form.guidelines.item_3')}</span>
                            </li>
                            <li className="flex items-start gap-1.5">
                                <span className="text-[#0066CC] shrink-0 mt-0.5">●</span>
                                <span>{t('form.guidelines.item_4')}</span>
                            </li>
                        </ul>
                    </div>
                </div>
