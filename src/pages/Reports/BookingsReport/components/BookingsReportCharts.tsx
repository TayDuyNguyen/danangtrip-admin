...
const BookingsReportCharts: React.FC<BookingsReportChartsProps> = ({
    ...
    if (isLoading || !data) {
        return (
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                <div className="p-[1px] rounded-3xl bg-gradient-to-br from-slate-200/20 via-slate-100/10 to-transparent lg:col-span-2">
                    <div className="bg-white rounded-[23px] p-6 h-[380px]">
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            ...
            <div className="p-[1px] rounded-3xl bg-gradient-to-br from-[#14b8a6]/20 via-slate-200/25 to-slate-100/10 shadow-xs hover:shadow-md hover:from-[#14b8a6]/30 transition-all duration-300 lg:col-span-2">
                <div className="bg-white rounded-[23px] p-6 flex flex-col justify-between h-[380px]">
            ...
            <div className="p-[1px] rounded-3xl bg-gradient-to-br from-[#14b8a6]/20 via-slate-200/25 to-slate-100/10 shadow-xs hover:shadow-md hover:from-[#14b8a6]/30 transition-all duration-300">
                <div className="bg-white rounded-[23px] p-6 flex flex-col justify-between h-[380px]">
                    <div>
                        <h3 className="text-[15px] font-black text-[#0F172A] leading-tight">{t('charts.status_title')}</h3>
                    ...
                    <div className="relative w-[180px] h-[180px] shrink-0 mx-auto flex items-center justify-center my-3">
                        {totalBookings === 0 ? (
                            <div className="text-center text-xs font-bold text-[#94A3B8]">{t('charts.no_data')}</div>
                        ) : (
                            <ResponsiveContainer width="100%" height="100%">
                                <PieChart>
                                    <Pie
                        ...
                        <div className="absolute flex flex-col items-center justify-center select-none text-center">
                            <span className="text-2xl font-black text-[#0F172A] leading-none">{totalBookings.toLocaleString()}</span>
                            <span className="text-[9px] font-black text-[#94A3B8] uppercase tracking-widest mt-1">{t('charts.bookings_label')}</span>
                        </div>
                    </div>

                    <div className="flex flex-col gap-1.5 border-t border-[#F1F5F9] pt-3">
                        {data.statuses.map((item) => (
                            <div key={item.status} className="flex justify-between items-center text-xs font-bold text-[#94A3B8] py-0.5">
