...
import { FileDown, MapPin, ChevronRight, LayoutDashboard, AlertTriangle, RefreshCw, Sparkles } from 'lucide-react';
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-50 pb-5">
                <div className="space-y-1.5">
                    ...
                    <div className="flex items-center gap-1.5 text-[11px] font-bold text-slate-400 select-none">
                        ...
                        <ChevronRight size={11} />
                        <span className="text-teal-500">{t('breadcrumb.current')}</span>
                    </div>

                    <div className="flex items-center gap-2.5">
                        <div className="w-9 h-9 bg-linear-to-br from-teal-500/20 to-teal-500/5 rounded-xl flex items-center justify-center text-teal-500 border border-teal-500/10 shadow-2xs">
                            <MapPin size={18} />
                        </div>
                        <div>
