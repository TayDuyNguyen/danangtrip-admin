        ...
        return (
            <div className="flex flex-col gap-6 mb-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="p-[1px] rounded-3xl bg-gradient-to-br from-slate-200/20 via-slate-100/10 to-transparent h-[360px]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="p-[1px] rounded-3xl bg-gradient-to-br from-slate-200/20 via-slate-100/10 to-transparent h-[320px]">
                        <div className="bg-white rounded-[23px] p-6 h-full">
                            <Skeleton className="w-48 h-6 mb-4" />
    ...
    return (
        <div className="flex flex-col gap-6 mb-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="p-[1px] rounded-3xl bg-gradient-to-br from-[#14b8a6]/20 via-slate-200/25 to-slate-100/10 shadow-xs hover:shadow-md hover:from-[#14b8a6]/30 transition-all duration-300 h-[360px]">
                    <div className="bg-white rounded-[23px] p-6 h-full flex flex-col justify-between">
                        <div className="flex justify-between items-center mb-4">
                            <div>
                                <h3 className="text-[15px] font-black text-[#0F172A] leading-tight">{t('charts.trend_title')}</h3>
                                <p className="text-[9px] font-black text-[#94A3B8] uppercase tracking-widest mt-0.5">{t('charts.trend_subtitle')}</p>
                            </div>
                        </div>
                ...
                <div className="p-[1px] rounded-3xl bg-gradient-to-br from-[#14b8a6]/20 via-slate-200/25 to-slate-100/10 shadow-xs hover:shadow-md hover:from-[#14b8a6]/30 transition-all duration-300 h-[360px]">
                    <div className="bg-white rounded-[23px] p-6 h-full flex flex-col justify-between">
                        <div className="flex justify-between items-center mb-4">
                            <div>
                                <h3 className="text-[15px] font-black text-[#0F172A] leading-tight">{t('charts.stars_distribution')}</h3>
                                <p className="text-[9px] font-black text-[#94A3B8] uppercase tracking-widest mt-0.5">{t('charts.stars_subtitle')}</p>
                            </div>
                            <div className="flex items-center gap-1 bg-yellow-50 text-yellow-600 font-extrabold text-[12px] px-3 py-1 rounded-xl border border-yellow-100/50">
                        ...
                        <div className="flex-1 flex flex-col justify-center gap-4">
                            {data.stars.map((item) => (
                                <div key={item.stars} className="flex items-center gap-3 w-full">
                                    ...
                                    <div className="h-6 bg-[#F8FAFC] border border-[#E2E8F0] rounded-lg flex-1 relative overflow-hidden">
                                        <div
                                    ...
                                    <div className="text-[12px] font-black text-[#0F172A] w-16 text-right">
                                        {item.count.toLocaleString()}
                                        <span className="text-[10px] font-bold text-[#94A3B8] ml-1">({item.percentage}%)</span>
                                    </div>
                                </div>
                            ))}
                        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="p-[1px] rounded-3xl bg-gradient-to-br from-[#14b8a6]/20 via-slate-200/25 to-slate-100/10 shadow-xs hover:shadow-md hover:from-[#14b8a6]/30 transition-all duration-300 h-[300px]">
                    <div className="bg-white rounded-[23px] p-6 h-full flex flex-col lg:flex-row gap-6 items-center">
                        <div className="flex-1 flex flex-col self-stretch justify-between">
                            <div>
                                <h3 className="text-[15px] font-black text-[#0F172A] leading-tight">{t('filter.moderation_status')}</h3>
                                <p className="text-[9px] font-black text-[#94A3B8] uppercase tracking-widest mt-0.5">{t('charts.status_subtitle')}</p>
                            </div>

                            <div className="flex flex-col gap-2 mt-4">
                                {data.statuses.map((item) => (
                                    <div key={item.status} className="flex justify-between items-center text-xs font-bold text-[#94A3B8] py-1 border-b border-[#F1F5F9]/50">
                                        ...
                                        <div className="text-right">
                                            <span className="text-[#0F172A] font-extrabold">{item.count.toLocaleString()}</span>
                                            <span className="text-[10px] text-[#94A3B8] ml-1">({item.percentage}%)</span>
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div className="relative w-[180px] h-[180px] shrink-0 flex items-center justify-center">
                            ...
                            <div className="absolute flex flex-col items-center justify-center select-none text-center">
                                <span className="text-2xl font-black text-[#0F172A] leading-none">{totalRatings.toLocaleString()}</span>
                                <span className="text-[9px] font-black text-[#94A3B8] uppercase tracking-widest mt-1">{t('stats.ratings')}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="p-[1px] rounded-3xl bg-gradient-to-br from-[#14b8a6]/20 via-slate-200/25 to-slate-100/10 shadow-xs hover:shadow-md hover:from-[#14b8a6]/30 transition-all duration-300 h-[300px]">
                    <div className="bg-white rounded-[23px] p-6 h-full flex flex-col justify-between">
                        <div className="flex justify-between items-center mb-2">
                            <div>
                                <h3 className="text-[15px] font-black text-[#0F172A] leading-tight">{t('charts.type_title')}</h3>
                                <p className="text-[9px] font-black text-[#94A3B8] uppercase tracking-widest mt-0.5">{t('charts.type_subtitle')}</p>
                            </div>
                        </div>
