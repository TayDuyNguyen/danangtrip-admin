                            ...
                            {isLoading ? (
                                ...
                                topTours.map((tour, index) => (
                                    <tr key={tour.id} className="hover:bg-slate-50/40 transition-colors group">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center gap-3">
                                                <div className="w-12 h-9 rounded-xl overflow-hidden border border-slate-100 shrink-0 bg-slate-50">
                                                    {tour.thumbnail || tour.image ? (
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <span className="text-[13px] font-black text-slate-900">{tour.revenue.toLocaleString(i18n.language === 'vi' ? 'vi-VN' : 'en-US')} {t('charts.unit_currency')}</span>
                                        </td>
                                        <td className="px-6 py-4 text-center">
                                            {tour.rating ? (
                                        ...
                                        <td className="px-6 py-4 text-center">
                                            {tour.status ? (
                                                ...
                                                <span className="text-slate-300 font-black uppercase text-[10px]">{t('status.active')}</span>
                                            )}
                                        </td>
                                    </tr>
                                ))
