...
interface CreateAdminConfirmDialogProps {
    isOpen: boolean;
    onClose: () => void;
    onConfirm: () => void;
    userName: string;
...
export const CreateAdminConfirmDialog = ({
    isOpen,
    onClose,
    onConfirm,
    userName,
    isMutating = false,
}: CreateAdminConfirmDialogProps) => {
    ...
    return (
        <div
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="create-admin-dialog-title"
            ...
            <div className="bg-white rounded-3xl border border-slate-100 shadow-2xl relative w-full max-w-md p-6 overflow-hidden animate-in scale-in duration-200 z-10">
                ...
                <div className="flex items-center justify-end gap-3 border-t border-slate-50 pt-4">
                    ...
                    <button
                        ...
                        onClick={onConfirm}
                        disabled={isMutating}
                        data-testid="create-admin-dialog-confirm"
...
export default CreateAdminConfirmDialog;
