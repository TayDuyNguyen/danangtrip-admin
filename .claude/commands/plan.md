...
Use `03-types-api-contract` and `04-layout-routing` to define contracts, route ownership, menu/breadcrumb impact, and page-shell changes before writing UI code.
